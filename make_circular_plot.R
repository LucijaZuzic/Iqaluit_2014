...
file_name <- paste0("afullframe_new.csv")
filtval <- 10
for (filteru in 0:1) {
  ...
  if (filteru) {
    ...
    plot_title <- paste0(clean_title, " by\nhour of day for Iqaluit, NU, Canada (2014)")
  } else {
  ...
  if (filteru) {
    save_name <- paste0("afullframe_filter_", var_start, " ", var_end, "_R.pdf")
    save_namep <- paste0("afullframe_filter_", var_start, " ", var_end, "_R.png")
  } else {
    save_name <- paste0("afullframe_", var_start, " ", var_end, "_R.pdf")
    save_namep <- paste0("afullframe_", var_start, " ", var_end, "_R.png")
  }
